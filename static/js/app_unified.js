/**
 * AI Video Script Generator - Unified JavaScript
 * Fixed option button handling and improved UX
 */
...
$(document).ready(function() {
    ...
    // Initialize
    console.log('🎬 AI Video Script Generator initialized');
    ...
    $(document).on('click', '.option-btn:not(:disabled)', function(e) {
        ...
        const optionText = $(this).find('.font-medium').text() || $(this).text();
        
        console.log('Option selected:', { value: optionValue, id: optionId, text: optionText });
    ...
    function sendMessage(message = null, optionValue = null) {
        ...
        console.log('Sending:', { message, optionValue });
        ...
        if (message && !optionValue) {
            ...
            const selectedText = $(`[data-option-value="${optionValue}"]`).find('.font-medium').text() || 
                               $(`[data-option-value="${optionValue}"]`).text() || 
                               optionValue;
